#WORK IN PROGRESS!!!
#Welcome to my Mini-game made by corgosDance! Thanks for downloading from the workshop or where ever you got it from. Maybe i gave it to you who knows. :)
...
#in an open area. You can build a arena around it if you want. Wire "Run" from both chips to the Button(this Starts and PAUSES, so it won't reset your progress, to do this simply reupload the code)
#Now Wire from the HUD Chip: E[Wirelink] to the EGP Screen. Then wire the rest from the HUD Chip to the Spawner so it tracks the Waves,LVL,EXP... 
